--- The file that auto-creates documentation for `copy_diagnostics`.
...
---
---@param text string Any text, e.g. `"copy_diagnostics.ClassName"`.
---@return string # The wrapped text, e.g. `"*copy_diagnostics.ClassName*"`.
---
...
---    The real name for the module. e.g. `"copy_diagnostics"`.
---
...
---@class copy_diagnostics.AutoDocumentationEntry
...
---    e.g. `"/out/copy_diagnostics.txt"`.

--- Make sure `paths` can be processed by this script.
---
---@param paths copy_diagnostics.AutoDocumentationEntry[]
...
local function main()
    ...
    local paths = {
        {
            source = vim.fs.joinpath(root, "lua", "copy_diagnostics", "init.lua"),
            destination = vim.fs.joinpath(root, "doc", "copy_diagnostics_api.txt"),
        },
        {
            source = vim.fs.joinpath(root, "lua", "copy_diagnostics", "types.lua"),
            destination = vim.fs.joinpath(root, "doc", "copy_diagnostics_types.txt"),
        },
    }
